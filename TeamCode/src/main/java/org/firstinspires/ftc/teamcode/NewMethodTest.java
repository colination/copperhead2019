...
@Autonomous(name="new method", group="12596")

public class NewMethodTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
          ...
          //  robot.driveTrain.srvMarker.setPosition(0.4);
            ...
            rotate(-7, .4);
            runToPositionDrive(1,1, -depotToPark, 3, 1);
...
//        double WHEEL_DIAMETER_INCHES = 4.0;     // For figuring circumference
        ...
        while ((robot.driveTrain.runtime.seconds() < timeoutS) &&
            ...
            else if (rem > (robot.driveTrain.COUNTS_PER_INCH * 6) && Inches > 6) {
                NLspeed = Lspeed;
                NRspeed = Rspeed;
            }
            else if (rem > (robot.driveTrain.COUNTS_PER_INCH * (Inches/2)) && Inches < 6) {
                NLspeed = Lspeed;
                NRspeed = Rspeed;
            }
